...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="display:flex; align-items:center">
        ...
        <div style="margin-left:20px; margin-top:10px; width:120px;">
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="TeacherDatasource" DataTextField="TEACHER_NAME" DataValueField="TEACHER_ID" AutoPostBack="true" Width="100%">
            </asp:DropDownList>
        </div>
